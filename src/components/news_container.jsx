...
import Products from './news_product'
    ...
    return (
      ...
      <Row>
          ...
          <Col span={22}>
              ...
              <div>
                  <NewsImageBlock title='国内新闻' count={8} type='guonei' width='100%' imageWidth='118px'/>
                  <NewsImageBlock title='娱乐新闻' count={16} type='yule' width='100%' imageWidth='118px'/>
              </div>
          </Col>
          <Col span={1}></Col>
      </Row>
